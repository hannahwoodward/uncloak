(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Uncloak = factory());
  ...
  var UncloakItem = function UncloakItem(node, instance, options) {
    ...
    this.lazyContent = node.hasAttribute('data-uncloak-ignore-lazy') ? [] : Array.from(node.querySelectorAll('[data-uncloak-src], [data-uncloak-srcset], [data-uncloak-picture]')).filter(function (el) { return !el.hasAttribute('data-uncloak-ignore'); });
